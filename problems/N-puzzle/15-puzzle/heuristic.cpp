...
void open_pdbs() {
    // tenemos 3 PDBs
	vector<string> filepdbs = {"15-puzzle_test1.pdb", "15-puzzle_test2.pdb", "15-puzzle_test3.pdb"};
    vector<string> fileabsts = {"15-puzzle_test1.abst", "15-puzzle_test2.abst", "15-puzzle_test3.abst"};
