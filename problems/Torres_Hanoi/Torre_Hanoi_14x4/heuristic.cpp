...
void open_pdbs() {
    // tenemos 2 PDBs
	vector<string> filepdbs = {"hanoi_14x4_group_1.pdb", "hanoi_14x4_group_2.pdb"};
    vector<string> fileabsts = {"hanoi_14x4_group_1.abst", "hanoi_14x4_group_2.abst"};
