...
void open_pdbs() {
    // tenemos 3 PDBs
	vector<string> filepdbs = {"hanoi_18x4_test1.pdb", "hanoi_18x4_test2.pdb", "hanoi_18x4_test3.pdb"};
    vector<string> fileabsts = {"hanoi_18x4_test1.abst", "hanoi_18x4_test2.abst", "hanoi_18x4_test3.abst"};
