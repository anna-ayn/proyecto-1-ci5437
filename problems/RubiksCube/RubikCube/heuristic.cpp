...
void open_pdbs() {
    // tenemos 3 PDBs
	vector<string> filepdbs = {"rubik3Sticker_corner_1.pdb", "rubik3Sticker_corner_2.pdb", "rubik3Sticker_corner_3.pdb", "rubik3Sticker_corner_4.pdb", "rubik3Sticker_edge_1.pdb", "rubik3Sticker_edge_2.pdb", "rubik3Sticker_edge_3.pdb", "rubik3Sticker_edge_4.pdb"};
    vector<string> fileabsts = {"rubik3Sticker_corner_1.abst", "rubik3Sticker_corner_2.abst", "rubik3Sticker_corner_3.abst", "rubik3Sticker_corner_4.abst", "rubik3Sticker_edge_1.abst", "rubik3Sticker_edge_2.abst", "rubik3Sticker_edge_3.abst", "rubik3Sticker_edge_4.abst"};
