...
void open_pdbs() {
    // tenemos 3 PDBs
	vector<string> filepdbs = {"topspin12x4_test1.pdb", "topspin12x4_test2.pdb", "topspin12x4_test3.pdb"};
    vector<string> fileabsts = {"topspin12x4_test1.abst", "topspin12x4_test2.abst", "topspin12x4_test3.abst"};
